...
from config import GAME_TYPES, MIN_WITHDRAWAL, STARS_TO_USD, STARS_TO_TON
...
from handlers.games import start_game_from_callback, start_repeat_game
from handlers.payments import send_invoice, process_withdrawal_confirmation
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if data == "confirm_withdraw":
            await process_withdrawal_confirmation(query, context)
            return
