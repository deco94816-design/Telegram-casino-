# handlers/games.py
# Game command handlers: /dice, /bowl, /arrow, /football, /basket, /demo, emoji handling
...
async def start_game_command(update: Update, context: ContextTypes.DEFAULT_TYPE, game_type: str):
    """Common function to start any game type."""
...
async def start_game_from_callback(query, context: ContextTypes.DEFAULT_TYPE, game_type: str):
    """Start a game from callback query (inline button)."""
...
async def demo_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /demo command - Admin only demo mode."""
    user_id = update.effective_user.id
