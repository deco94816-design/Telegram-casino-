# handlers/basic.py
# Basic bot commands: start, help, balance, profile, history, play
...
from config import STARS_TO_USD, GAME_TYPES, RANKS
...
async def balance_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle the /balance and /bal commands."""
    user_id = update.effective_user.id
    balance = get_user_balance(user_id)
    balance_usd = balance * STARS_TO_USD
...
async def play_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle the /play command to show game selection."""
    user_id = update.effective_user.id
