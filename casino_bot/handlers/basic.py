# handlers/basic.py
# Basic command handlers: /start, /help, /balance, /profile, /history, /play
...
from config import GAME_TYPES, RANKS, STARS_TO_USD
...
async def balance_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /balance and /bal commands - Show user balance."""
    user_id = update.effective_user.id
    balance = get_user_balance(user_id)
    balance_usd = balance * STARS_TO_USD
...
async def history_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /history command - Show user game history and stats."""
    user = update.effective_user
    user_id = user.id
