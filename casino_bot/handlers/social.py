# handlers/social.py
# Social command handlers: /tip, /bonus

from telegram import Update
from telegram.ext import ContextTypes
from telegram.constants import ParseMode

from config import BONUS_AMOUNT, BOT_USERNAME, STARS_TO_USD, logger
from database import (
    user_balances, user_profiles, user_bonus_claimed,
    username_to_id, save_data
)
from utils.decorators import handle_errors
from utils.helpers import (
    is_admin, get_user_balance, adjust_user_balance, get_user_link,
    get_or_create_profile, check_bot_name_in_profile, get_user_id_by_username
)


@handle_errors
async def bonus_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /bonus command - Claim profile name bonus."""
...
async def tip_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle /tip command - Tip other users."""
