...
def handle_errors(func):
    """
    Decorator to handle common Telegram API errors gracefully.
    
    Catches BadRequest, Forbidden, NetworkError, and other TelegramErrors,
    logging them and providing user-friendly error messages.
    """
    @wraps(func)
