# database.py
# Data persistence and all shared data structures
...
# Locks for concurrent game access
...
def increment_withdrawal_counter():
    """Increment and return new withdrawal counter."""
...
def set_withdraw_video(file_id):
